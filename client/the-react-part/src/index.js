...
function App() {
  ...
  return (
    <div>
      ...
      <select name = "fund_type" id ="fund_type" onChange = {(event) => {
      ...
      <label>Unit: </label>
      <select name = "unit" id ="unit" onChange = {(event) => {
        ...
        <option value = "equal_opportunity">Equal Opportunity Affirm Action</option>
      ...
      <select name = "preaward" id ="preaward" onChange = {(event) => {
      ...
      <select name = "pre_award_poc" id ="pre_award_poc" onChange = {(event) => {
      ...
      <select name = "post_award_poc" id ="post_award_poc" onChange = {(event) => {
      ...
      <select name = "internal_approval" id ="internal_approval" onChange = {(event) => {
      ...
      <select name = "certification_assurance" id ="certification_assurance" onChange = {(event) => {
      ...
      <select name = "financial_interest" id ="financial_interest" onChange = {(event) => {
      ...
      <label>RCR: </label>
      <select name = "rcr" id ="rcr" onChange = {(event) => {
